<template>
  ...
  >
    ...
    <ContentSidebar
      v-if="$page.frontmatter.contentSidebar"
      @toggle-content-sidebar="toggleContentSidebar"
    />
  </div>
</template>
...
export default {
      ...
      return [
        {
          ...
          "content-sidebar-open": this.isContentSidebarOpen,
        },
        userPageClass,
      ];
    },
  ...
  methods: {
    ...
    toggleContentSidebar(to) {
      this.isContentSidebarOpen =
        typeof to === "boolean" ? to : !this.isContentSidebarOpen;
    },
    ...
    onScroll: throttle(function () {
      ...
      if (!this.$contentLinks) {
        this.$contentLinks = [].slice.call(
          document.querySelectorAll(".content-sidebar-link")
        );
      }
