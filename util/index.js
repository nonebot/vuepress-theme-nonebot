...
export function normalize(path) {
  ...
  const result = decodeURI(path).replace(hashRE, "").replace(extRE, "");
...
export function resolveSidebarItems(
  ...
  if (page.version) {
    const versionedConfig =
      site.themeConfig.versionedSidebar &&
      site.themeConfig.versionedSidebar[page.version];
    localeConfig =
      localePath && versionedConfig.locales
...
export function versionifyUserNav(
  navConfig,
  currentPage,
  currentVersion,
  localePath,
